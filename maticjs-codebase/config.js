...
// Mapped tokens on plasma and PoS bridge from https://docs.matic.network/docs/develop/network-details/mapped-tokens
module.exports = {
  plasma: {
    parent: {
  ...
  user1: {
    privateKey: process.env.PRIVATE_KEY, // A sample private key prefix with `0x`
    address: "0x8EB23c83Fbf72AdA2220F83175593a1207232c80", // Your address
  },
  user2: {
    address: "0xB2eb150F643c280725355A5321fc0835Ba44Ec3b", // Your address
  },
};
